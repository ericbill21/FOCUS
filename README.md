...
<div style="display: flex; justify-content: center; gap: 20px;">
  <div style="text-align: center;">
    <sub><b  style="font-size: x-large">Base Models</b></sub><br>
    <img src="static/images/base.png" width="500"/>
  </div>
  <div style="text-align: center;">
    <sub><b  style="font-size: x-large">Base Models + FOCUS (Ours)</b></sub><br>
    <img src="static/images/focus.png" width="500"/><br>
  </div>
</div>
